    ...
    <main className="min-h-[100dvh] bg-gradient-to-b from-white to-neutral-50">
      <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-neutral-900">Onboarding complete</h1>
          <p className="mt-3 max-w-xl text-neutral-600">
            Thanks for sharing your details. We saved your preferences and brand inputs. You can jump into your dashboard or revisit onboarding to make quick tweaks anytime.
          </p>
          ...
          <div className="mt-10 grid w-full gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-neutral-200 bg-white p-4 text-left shadow-sm">
              ...
              <div className="mt-1 text-sm text-neutral-600">Our team will review your inputs and get your workspace ready.</div>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-white p-4 text-left shadow-sm">
              ...
              <div className="mt-1 text-sm text-neutral-600">You can revisit onboarding to adjust details at any time.</div>
            </div>
          </div>

          <div className="mt-10 text-xs text-neutral-500">Ref: Onboarding Success</div>
        </div>
      </div>
    </main>
  );
