...
export default function DashboardOnboardingSuccessPage() {
    ...
    <main className="min-h-[100dvh] bg-gradient-to-b from-white to-neutral-50">
      <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-neutral-900">Onboarding saved</h1>
          <p className="mt-3 max-w-xl text-neutral-600">
            Your details have been saved. Well now set up your workspace. Youre being redirected to your dashboard.
          </p>
          ...
          <div className="mt-10 grid w-full gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-neutral-200 bg-white p-4 text-left shadow-sm">
              ...
              <div className="mt-1 text-sm text-neutral-600">Well review your inputs and get things ready.</div>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-white p-4 text-left shadow-sm">
              ...
              <div className="text-sm font-medium text-neutral-900">Next up</div>
              <div className="mt-1 text-sm text-neutral-600">Youll land in your dashboard. Keep an eye on status and tasks.</div>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-white p-4 text-left shadow-sm">
              ...
              <div className="mt-1 text-sm text-neutral-600">You can return to onboarding and adjust details anytime.</div>
            </div>
          </div>

          <div className="mt-10 text-xs text-neutral-500">Ref: Dashboard Onboarding Success</div>
        </div>
      </div>
    </main>
  );
