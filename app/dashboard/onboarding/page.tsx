...
export default function DashboardOnboardingPage() {
  ...
  const [answers, setAnswers] = useState<string>(
    JSON.stringify(
      {
        brand: { name: "Acme", tagline: "We do things better" },
  ...
  async function handleGenerate() {
    try {
      ...
      // If deploying, poll deployment URL
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 space-y-10">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold">Onboarding → Site Builder</h1>
      ...
      <section className="rounded-xl border border-neutral-200 p-4 shadow-sm space-y-4 bg-white">
        <div className="text-sm font-medium text-neutral-800">1) Configure</div>
