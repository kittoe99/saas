            ...
            <div className="md:flex md:items-end md:justify-between gap-8">
              ...
              <div className="mt-6 md:mt-0 text-sm">
                ...
                <div className="mt-3 flex gap-5 overflow-x-auto no-scrollbar whitespace-nowrap">
                  <a href="#x" aria-label="X" className="text-[#faf6ec] hover:text-[#faf6ec]">X</a>
                  <a href="#linkedin" aria-label="LinkedIn" className="text-[#faf6ec] hover:text-[#faf6ec]">LinkedIn</a>
                  <a href="#github" aria-label="GitHub" className="text-[#faf6ec] hover:text-[#faf6ec]">GitHub</a>
                  <a href="#instagram" aria-label="Instagram" className="text-[#faf6ec] hover:text-[#faf6ec]">Instagram</a>
                </div>
              </div>
            </div>
            <FooterLinks />
