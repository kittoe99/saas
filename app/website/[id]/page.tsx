    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      <header className="sticky top-0 z-30 border-b border-neutral-200 bg-white/95 backdrop-blur-sm">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <nav aria-label="Breadcrumb" className="text-[12px] text-neutral-600">
            <ol className="flex items-center gap-1">
              <li>
                <a href="/dashboard" className="hover:underline text-neutral-700">Dashboard</a>
              </li>
              <li aria-hidden className="text-neutral-400">/</li>
              <li aria-current="page" className="truncate max-w-[14rem] sm:max-w-[20rem] text-neutral-800">
                {name || 'Website'}
              </li>
            </ol>
          </nav>
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                {/* Website ID intentionally hidden from UI */}
              </div>
            </div>
